...
namespace Cb.Utility
{
    public static class Utils
    {
        ...
        public static string GetScmplitBySpace(string name, string pathTree)
        {
            ...
            result += result.Length > 0 ? string.Format("&nbsp;&nbsp;{0}", name) : string.Format("<b>{0}</b>", name);
            return result;
        }
        ...
        public static string GetScmplit(string name, string pathTree)
        {
            ...
            result += result.Length > 0 ? string.Format(" |{0}|{1} ", count, name) : string.Format("|{0}|{1} ", count, name);
            return result;
        }
