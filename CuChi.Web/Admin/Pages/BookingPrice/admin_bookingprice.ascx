            ...
            <asp:GridView ID="grdBookingPrice"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Price class">
                        <ItemTemplate>
                            <asp:Label ID="lbPriceClass" runat="server" Text='<%# Eval("PriceClassNameDesc")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Label ID="lbPriceClass" runat="server" Text='<%# Eval("PriceClassNameDesc")%>' Visible="false"></asp:Label>
                            <asp:DropDownList ID="drpPriceClass" runat="server" Width="100px">
                            </asp:DropDownList>
                        </EditItemTemplate>
