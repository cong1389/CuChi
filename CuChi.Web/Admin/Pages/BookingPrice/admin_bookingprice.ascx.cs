...
namespace Cb.Web.Admin.Pages.BookingPrice
{
    public partial class admin_bookingprice : DGCUserControl
    {
        ...
        PriceClassBLL bllPriceClass = new PriceClassBLL();
        IList<PNK_PriceClass> lstPriceClass;
        ...
        private void BindData()
        {
            ...
            lst = bll.GetList(DBConvert.ParseInt(ProductId),out total);
            if (lst.Count() > 0)
            {
        ...
        private int Save(string id, string priceClass, string name, string value, int min, int max, string groupType, bool published)
        {
            ...
            if (priceId == int.MinValue)
            {
                ...
                productcatObj.PriceClassId = priceClass;
        ...
        {
            string priceClass = ((DropDownList)grdBookingPrice.FooterRow.FindControl("drpPriceClass")).SelectedValue;
        ...
        protected void grdBookingPrice_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string priceClass = ((DropDownList)grdBookingPrice.Rows[e.RowIndex].FindControl("drpPriceClass")).SelectedValue;
        ...
        protected void grdBookingPrice_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if ((e.Row.RowState & DataControlRowState.Edit) > 0)
                {
                    ...
                    DropDownList drpPriceClass = (DropDownList)e.Row.FindControl("drpPriceClass");
                    if (drpPriceClass != null)
                    {
                        lstPriceClass = bllPriceClass.GetList();
                        drpPriceClass.DataSource = lstPriceClass;
                        drpPriceClass.DataTextField = "Name";
                        drpPriceClass.DataValueField = "Id";
        ...
        protected void grdBookingPrice_DataBound(object sender, EventArgs e)
        {
            ...
            DropDownList drpPriceClass = grdBookingPrice.FooterRow.FindControl("drpPriceClass") as DropDownList;
            if (drpPriceClass != null)
            {
                lstPriceClass = bllPriceClass.GetList();
                drpPriceClass.DataSource = lstPriceClass;
