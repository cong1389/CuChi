                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab_1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-2 control-label">
                                                        <label>
                                                            <asp:Literal ID="ltrSkypeAcc" runat="server" Text="ltrSkypeAcc"></asp:Literal>
                                                        </label>
                                                    </label>
                                                    <div class="col-sm-4">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <a href="https://developers.facebook.com/docs/plugins/page-plugin" target="_blank">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-sm-2 control-label">
                                                                            <label>
                                                                                <asp:Literal ID="Literal14" runat="server" Text="FanPage Twitter"></asp:Literal>
                                                                            </label>
                                                                        </label>
                                                                        <div class="col-sm-4">
                                                                        ...
                                                                        <label class="col-sm-2 control-label">
                                                                            <label>
                                                                                <asp:Literal ID="Literal20" runat="server" Text="VChat"></asp:Literal>
                                                                            </label>
                                                                        </label>
                                                                        <div class="col-sm-4">
