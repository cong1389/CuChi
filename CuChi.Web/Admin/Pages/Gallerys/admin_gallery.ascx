<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_gallery.ascx.cs"
    Inherits="Cb.Web.Admin.Pages.Gallerys.admin_gallery" %>
<!--admin_gallery-->
                    ...
                    <div class="form-horizontal hidden">
                        <div class="form-group">
                            ...
                            <label class="col-sm-2 control-label">
                                <asp:Literal ID="strHeaderGallery" runat="server" Text="strHeaderGallery"></asp:Literal></label>
                            <div class="col-sm-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover tbl-news">
                            <tr class="txt-bold tbl-title ">
                                ...
                                <th>
                                    <asp:Literal ID="ltrAdminHeaderGalleryCategory" runat="server" Text="Tên sản phẩm"></asp:Literal>
                                </th>
                                <th>
