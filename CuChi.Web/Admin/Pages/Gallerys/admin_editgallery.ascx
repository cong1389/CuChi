<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_editgallery.ascx.cs"
    Inherits="Cb.Web.Admin.Pages.Gallerys.admin_editgallery" %>
...
<%@ Register TagPrefix="dgc" TagName="ucMessageEmty" Src="~/Admin/Controls/ucMessageEmty.ascx" %>
...
<script type="text/javascript">
    ...
    //    alert(fileName);
    //    //  jQuery("#txtNameFileUpload").val(fileName);//ss attr("src", "/Resource/UpLoad/Gallerys" + "/" + fileName);
    //}
    ...
    jQuery(document).ready(function () {
        ...
        var categoryID = $("#hddGalleryCategoryId").val();
        if (categoryID < 0) {
...
<section class="content-header ulBtn btnEdit">
    <div class="row ">
        <div class="col-xs-12">
            ...
            <button validationgroup="admingalleryCategory" id="btn_Save" runat="server" onserverclick="btnSave_Click" class="btn btn-success">
                <i class="fa fa-check"></i>
                <asp:Literal ID="ltrAdminSave" runat="server"></asp:Literal>
            </button>

            <button validationgroup="admingalleryCategory" id="btn_Delete" runat="server" onserverclick="btnDelete_Click" class="btn btn-success" visible="false">
                <i class="fa fa-check"></i>
                <asp:Literal ID="ltrAdminDelete" runat="server"></asp:Literal>
            </button>

            <button id="btn_Cancel" runat="server" onserverclick="btnCancel_Click" type="button" name="back" class="btn btn-secondary-outline" causesvalidation="false">
                <i class="fa fa-angle-left"></i>
                <asp:Literal ID="ltrAdminCancel" runat="server"></asp:Literal>
            </button>

            <button validationgroup="admingalleryCategory" id="btn_Apply" runat="server" type="button" name="btn_Apply" class="btn btn-secondary-outline" onserverclick="btnApply_Click" visible="false">
                ...
                <div class="form-horizontal">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:ValidationSummary ID="sumv_SumaryValidate" ValidationGroup="admingalleryCategory" DisplayMode="BulletList" ShowSummary="true" runat="server" EnableClientScript="true" ViewStateMode="Disabled" CssClass="col-md-5 ValidationSummary" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="drpCategory"
                                    runat="server" ValidationGroup="admingalleryCategory" SetFocusOnError="true" Display="None"></asp:RequiredFieldValidator>
                        ...
                        <div class="tabbable tabbable-tabdrop">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="adnGeneral" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal14" runat="server" Text="Gallerys"></asp:Literal></label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal15" runat="server" Text="Gallery Application"></asp:Literal></label>
                                                        <div class="col-sm-10">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="adnGeneralEng" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal219" runat="server" Text="Gallerys"></asp:Literal></label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group hidden">
                                                        <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal20" runat="server" Text="Gallery Application"></asp:Literal></label>
                                                        <div class="col-sm-10">
                                ...
                                <div class="tab-pane " id="tab_3">                                    
                                    ...
                                    <dgc:ucMessageEmty ID="ucMessageEmty3" runat="server" />
                                </div>
                                <!-- /.tab-pane -->
                                <div class="tab-pane" id="tab_4">
                                    <dgc:block_uploadimage Id="block_uploadimage" runat="server" />
                                    <dgc:ucMessageEmty ID="ucMessageEmty4" runat="server" />
                                </div>
                                <!-- /.tab-pane -->
                                <div class="tab-pane tabUploadVideo" id="tab_5">
                                    <dgc:block_uploadvideo Id="block_uploadvideo" runat="server" />
                                    <dgc:ucMessageEmty ID="ucMessageEmty5" runat="server" />
                                </div>
                                <!-- /.tab-pane -->
                                <div class="tab-pane" id="tab_6">
                                    <dgc:block_uploadfile ID="block_uploadfile" runat="server" />
                                     <dgc:ucMessageEmty ID="ucMessageEmty6" runat="server" />
                                </div>
                                <div class="tab-pane" id="tab_7">
                                    <dgc:block_mapsmulti Id="block_mapsmulti" runat="server" />
                                    <dgc:ucMessageEmty ID="ucMessageEmty7" runat="server" />
                                </div>
                                <div class="tab-pane" id="tab_8">
                                    <div class="panel panel-default" runat="server" id="divProgramTour">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
...
<input id="hddGalleryCategoryId" type="hidden" name="hddGalleryCategoryId" value="<%=gallerycategoryId%>" />
