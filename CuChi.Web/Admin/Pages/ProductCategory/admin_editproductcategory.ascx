                ...
                <div class="form-horizontal">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-xs-8 checkbox">
                            ...
                            <label class="col-sm-2 col-xs-3 control-label">
                                <asp:Literal ID="Literal1" runat="server" Text="Top Destination"></asp:Literal></label>
                            <div class="col-sm-1 col-xs-8 checkbox">

                                <div class="checkbox-list" data-error-container="#form_2_services_error">
                                    <label>
                                        <input type="checkbox" name="chkPublished" id="chkTop" checked runat="server" class="noPM" />
                                    </label>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <%--    <asp:TextBox ID="txtOrder" TextMode="Number" runat="server" min="1" max="2000"
