...
<!---block_slide-->
<%@ Register TagPrefix="dgc" TagName="block_filter" Src="~/Controls/block_filter.ascx" %>

<div class="clear">
</div>
<div class="gdl-top-slider banner">
    <div class="gdl-top-slider-wrapper full-slider">
        ...
        <div id="slider1_container" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 470px; overflow: hidden;">
            <!-- Loading Screen -->
            <div u="loading" style="position: absolute; top: 0px; left: 0px;">
                <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;">
                </div>
                <div style="position: absolute; display: block; background: url(/assets/wp-content/plugins/jssor/img/loading.gif) no-repeat center center; top: 0px; left: 0px; width: 100%; height: 100%;">
                </div>
            </div>
            <!-- Slides Container -->
            ...
            */
                .jssorb21 div, .jssorb21 div:hover, .jssorb21 .av {
                    background: url(/assets/wp-content/plugins/jssor/img/b21.png) no-repeat;
                    overflow: hidden;
                    cursor: pointer;
                }
            ...
            */
                .jssora21l, .jssora21r, .jssora21ldn, .jssora21rdn {
                    ...
                    cursor: pointer;
                    display: block;
                    background: url(/assets/wp-content/plugins/jssor/img/a21.png) center center no-repeat;
                    overflow: hidden;
                }
        ...
        <dgc:block_filter ID="block_filter" runat="server" />
...
<div class="under-slider-wrapper">
    <asp:Literal runat="server" ID="ltrSlogan"></asp:Literal>
</div>
<!--/block_slogan-->
