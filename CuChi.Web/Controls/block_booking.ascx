                        ...
                        <li class=" mt-step-col first done">
                            <a href="#tab1" data-toggle="tab" class="step">
                                <div class=" mt-step-title">
                                    <div class="mt-step-number bg-white"><i class="icon-credit-card"></i></div>
                                ...
                                <section class="three-fourth">
                                    <div id="booking" class="booking">
                                                ...
                                                <tr style="background-color: rgba(255,255,255,0.7);">
                                                    ...
                                                    <td class="total">
                                                        <span class="bt-content">
                                                            <strong class="pull-left">Adult : </strong>
                                                            <span class="pull-right"><span class="right" id="spanAdultPrice"></span></span>
                                                            <br />
                                                            <strong class="pull-left">Child : </strong>
                                                            <span class="pull-right"><span class="right" id="spanChildPrice"></span></span>
                                                            <br />
                                                            <strong class="pull-left">Infant : </strong>
                                                            <span class="pull-right"><span class="right" id="spanInfatPrice"></span></span>
                                                            
                                                            <br />
                                                            <hr class="hrTotal"/>
                                                            <strong class="pull-left">Total : </strong>
                                                            <span class="pull-right"><b> <span class="right" id="spanSum"></span></b></span>
                                                        </span>
                                        ...
                                        <table id="cart" style="margin-top: 10px;" class='table table-bordered'>
                                            <tbody>
                                                <tr class="total">
                                                    <td class="text-right portlet blue" style="white-space: nowrap; width: 75%">
                                                        <strong>COST:</strong>
                                                    </td>
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <asp:Button ID="btnSend" runat="server" class="btn red button-submit" Text="Check Out Now"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#<%=drpCity.ClientID%>').change(function () {
            cityId = $('#<%=drpCity.ClientID%> option:selected').text();
    ...
    function GetBooking_Price() {
        ...
        param.priceClassId = $('#<%=drpPriceClass.ClientID%> option:selected').val();
        param.groupType = $('#<%=drpTourGroup.ClientID%> option:selected').text();
        param.adultQuantity = $('#<%=txtNumberAduts.ClientID%>').val();
        param.childQuantity = $('#<%=txtNumberChild.ClientID%>').val();
        param.infantQuantity = $('#<%=txtNumberInfant.ClientID%>').val();
        ...
        jQuery.ajax({
            ...
            success: function (result) {
                ...
                $("#spanAdultPrice").html(param.adultQuantity + 'x $' + result.d[4] + '= $' + result.d[5]);
                $("#spanChildPrice").html(param.childQuantity + 'x $' + result.d[6] + '= $' + result.d[7]);
                $("#spanInfatPrice").html(param.infantQuantity + 'x $' + result.d[8] + '= $' + result.d[9]);
                ...
                $("#spanExchangeVND").html(exchangeCost);

                $('#<%=hddPriceSumValue.ClientID%>').val(result.d[10]);
                $('#<%=hddFinalCost.ClientID%>').val(exchangeCost);
            },
            error: function (x) {
        ...
        function GetExchangeCurrent() {
            jQuery.ajax({
                ...
                success: function (result) {
                    ...
                    jQuery("#spanExchangeCurrent").html('VND ' + result.d);
                },
                error: function (x) {
                    alert("error:" + x.responseText);
                }
...
<asp:HiddenField runat="server" ID="hddFinalCost" />
